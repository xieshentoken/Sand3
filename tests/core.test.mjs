...
assert.equal(phasePassesElementFilter(["Li", "O"], { required: ["Li"], optional: ["O", "S"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li", "S"], { required: ["Li"], optional: ["O", "S"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li", "O", "S"], { required: ["Li"], optional: ["O", "S"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li"], { required: ["Li"], optional: ["O", "S"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li", "O", "Fe"], { required: ["Li"], optional: ["O", "S"], onlySelectedElements: true }), false);
assert.equal(phasePassesElementFilter(["Li", "S"], { required: ["Li", "S"], optional: ["O"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li", "O", "S"], { required: ["Li", "S"], optional: ["O"], onlySelectedElements: true }), true);
assert.equal(phasePassesElementFilter(["Li", "O"], { required: ["Li", "S"], optional: ["O"], onlySelectedElements: true }), false);
